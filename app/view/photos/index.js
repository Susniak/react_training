...
import PhotoAlbumActions from "../../data-layer/actions/photo-albums.actions";
...
const config = {
    ...
    actions: PhotoAlbumActions,
    fetchUrl: 'photo-albums',
    bemClass: 'photo-albums',
    texts: {
        removeConfirmation: 'Czy na pewno chcesz usunac ten album?',
        add: 'Dodawanie albumu',
        edit: 'Edytowanie albumu',
        title: 'Albumy zdjec'
    },
...
class PhotoAlbums extends React.Component {
    ...
    render() {
        return <div className={config.bemClass}>
            ...
            <FetchDataComponent url={config.fetchUrl} action={config.actions.set.bind(PhotoAlbumActions)}>
...
const PhotoAlbumsComponent = connect(config.mapStateToProps)(PhotoAlbums);

export default PhotoAlbumsComponent;
